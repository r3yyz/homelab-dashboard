/* ============================================================
   ...
   Usage : ICONS.get('shield', 32) → string HTML
   Chargé en premier pour être disponible dans tous les modules.
============================================================ */
...
const ICONS = {
    _lib: {
        ...
        droplet:  '<path d="M12 2C6 9 4 13.5 4 16a8 8 0 0 0 16 0c0-2.5-2-7-8-14z"/>',
    },

    get(name, size = 16, cls = '') {
        const d = this._lib[name] || this._lib.info;
        return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
            width="${size}" height="${size}" class="${cls}" aria-hidden="true"
